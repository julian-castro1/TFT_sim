...
export function handleCanvasClick(x, y, touchZones) {
    const result = {
        hit: false,
        coordinates: { x, y }
    };
...
function executeTouchAction(zone) {
...
export function getTouchZonesInArea(x, y, width, height, touchZones) {
...
export function doTouchZonesOverlap(zone1, zone2) {
...
export function getTouchZoneCenter(zone) {
    return {
...
export function createTouchZone(x, y, width, height, action) {
    return {
